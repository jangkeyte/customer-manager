...
@if(isset($options))
<div class="dropdown">
    <button type="button" class="btn-primary btn-mini dropdown-toggle btn-block" data-bs-toggle="dropdown" id="dropdownMenu_{!! $options->first() !!}" aria-haspopup="true" aria-expanded="true">
        - Chọn -
